    ...
    <adminSettings>
      <div class="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
          ...
          <div class="flex items-center">
            <form  class="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
              <label for="login-password">
                <span class="text-sm text-gray-500">Current Password</span>
                <div class="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600">
                  <input type="password" v-model="password" class="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
              ...
              <label for="login-password">
                ...
                <div class="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600">
                  <input type="password" v-model="cpassword" class="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
          ...
          <button @click="updateAdminHandler" class="mt-4 rounded-lg bg-blue-600 px-4 py-2 text-white">Save Password</button>
          <hr class="mt-4 mb-8" />
  ...
  import adminSettings from "@/layouts/adminSettings.vue";
    export default {
      ...
      this.errors = {};
        ...
        try{
        await axios.put(`http://localhost:8080/auth/updatePassword/${this.email}/${this.password}`,{
